...
@Component({
  selector: 'app-ficha',
  templateUrl: './ficha-encarregados.component.html',
  styleUrls: ['./ficha-encarregados.component.css']
})

@Injectable()
export class FichaEncarregadosComponent implements OnInit {
  ...
  registerFormEncarregadoLocal!: FormGroup;
  ...
  ngOnInit() {
    this.validation();
    this.condicaoCarousel = 'ENCARREGADO';
    this.condicaoTitulo = 'Encarregados';
  ...
  validation() {
    this.registerFormEncarregadoLocal = this.fb.group({
      id: [''],
  ...
  cadastrarPessoa(modalDadosPessoais: any) {
    this.registerFormEncarregadoLocal.reset();
    ...
    this.registerFormEncarregadoLocal.patchValue({
  ...
  salvarPessoa(modalDadosPessoais: any, modalAluno: any) {
    var pessoa = Object.assign({}, this.registerFormEncarregadoLocal.value);
    if (this.registerFormEncarregadoLocal.valid) {
        ...
        this.pessoaService.atualizarPessoa(pessoaPut)
          .subscribe(
            (pessoa: Pessoa) => {
              ...
              this.listarMusicos('ENCARREGADO');
  ...
  abrirModalEncarregado(pessoa: Pessoa, modalAluno: any) {
